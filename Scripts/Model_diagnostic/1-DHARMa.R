...
###residual quartiles
png(filename=paste0('C:/Users/G00399072/OneDrive - Atlantic TU/Desktop/call_paper/graphs/dharma/mod1_dharma1.png'),
    width     = 300,
    height    = 200,
    units     = "mm",
    res       = 600)
...
png(filename=paste0('C:/Users/G00399072/OneDrive - Atlantic TU/Desktop/call_paper/graphs/dharma/mod2_dharma1.png'),
    width     = 300,
    height    = 200,
    units     = "mm",
    res       = 600)
...
png(filename=paste0('C:/Users/G00399072/OneDrive - Atlantic TU/Desktop/call_paper/graphs/dharma/mod1_dharma2.png'),
    width     = 200,
    height    = 200,
    units     = "mm",
    res       = 600)
...
png(filename=paste0('C:/Users/G00399072/OneDrive - Atlantic TU/Desktop/call_paper/graphs/dharma/mod2_dharma2.png'),
    width     = 200,
    height    = 200,
    units     = "mm",
    res       = 600)
...
#dispersion & outliers
png(filename=paste0('C:/Users/G00399072/OneDrive - Atlantic TU/Desktop/call_paper/graphs/dharma/mod1_dharma3.png'),
    width     = 300,
    height    = 200,
    units     = "mm",
    res       = 600)
par(mfrow = c(1,2))
testDispersion(res1)
mtext('A', side=3, cex = 1.5, line=1, at=0.2)
DHARMa::testOutliers(res1, plot = T)
dev.off()

png(filename=paste0('C:/Users/G00399072/OneDrive - Atlantic TU/Desktop/call_paper/graphs/dharma/mod2_dharma3.png'),
    width     = 300,
    height    = 200,
    units     = "mm",
    res       = 600)
...
png(filename=paste0('C:/Users/G00399072/OneDrive - Atlantic TU/Desktop/call_paper/graphs/dharma/mod1_dharma4.png'),
    width     = 180,
    height    = 120,
    units     = "mm",
    res       = 600)
...
png(filename=paste0('C:/Users/G00399072/OneDrive - Atlantic TU/Desktop/call_paper/graphs/dharma/mod2_dharma4.png'),
    width     = 180,
    height    = 120,
    units     = "mm",
    res       = 600)
